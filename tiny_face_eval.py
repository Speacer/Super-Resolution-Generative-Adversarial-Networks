...
def main():
  ...
  argparse.add_argument('--weight_file_path', type=str, help='Pretrained weight file.', default="H:\PYthon\Tiny_Faces_in_Tensorflow-master\model\mat2tf.pkl")
  argparse.add_argument('--data_dir', type=str, help='Image data directory.', default="H:\PYthon\Tiny_Faces_in_Tensorflow-master\input_image_directory")
  argparse.add_argument('--output_dir', type=str, help='Output directory for images with faces detected.', default="H:\PYthon\Tiny_Faces_in_Tensorflow-master\output_image_directory")
